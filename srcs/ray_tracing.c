...
/*   Updated: 2022/11/06 17:16:12 by iguscett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_wall_height_texture(t_data *data, int ix)
{
	...
	data->wall.wall_height_px = (int)(data->wall.wall_height
			/ data->screen.yincr);
	data->wall.low_limit_px = (data->height - data->wall.wall_height_px) / 2;
	data->wall.high_limit_px = data->wall.low_limit_px
		+ data->wall.wall_height_px;
...
void	texture_colums(t_data *data, int ix)
{
	...
	{
		color = get_image_pixel_color(&data->wall.texture,
				data->wall.column, (double)(row - data->wall.low_limit_px)
				/ data->wall.wall_height_px);
